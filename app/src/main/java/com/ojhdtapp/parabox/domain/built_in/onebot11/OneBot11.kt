...
import com.ojhdtapp.parabox.domain.built_in.BuiltInExtension
...
object OneBot11 : BuiltInExtension {
    override val key: String
        get() = "onebot11"
    override val extensionInfo: ExtensionInfo.BuiltInExtensionInfo
        get() = ExtensionInfo.BuiltInExtensionInfo(
            "OneBot 11",
            null,
            "通用聊天机器人应用接口标准（版本11）",
            key
    ...
    override val initHandler: ParaboxInitHandler
        get() = OneBot11InitHandler()
    override val connection: ParaboxConnection
        get() = object : ParaboxConnection() {
