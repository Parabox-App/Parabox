        ...
        LazyColumn(
            ...
            item {
                Text(
                    ...
                    text = stringResource(R.string.setup_fcm_sender_text_a),
                        ...
                        Row() {
                            ...
                            Column(modifier = Modifier.weight(1f)) {
                                Box(
                                    ...
                                    Text(
                                        text = stringResource(R.string.setup_fcm_sender_step_a_title),
                                        style = MaterialTheme.typography.bodyLarge,
                                        color = MaterialTheme.colorScheme.onSurface
                                    )
                                }
                                ...
                                AnimatedVisibility(visible = currentStep == 1) {
                                    Column(
                                        ...
                                        Text(
                                            text = stringResource(R.string.setup_fcm_sender_step_a_text),
                            ...
                            Column(modifier = Modifier.weight(1f)) {
                                ...
                                AnimatedVisibility(visible = currentStep == 3) {
                                    Column(
                                        ...
                                        Text(
                                            modifier = Modifier.padding(vertical = 8.dp),
                                            text = stringResource(R.string.setup_fcm_sender_step_d_text_a),
                                            style = MaterialTheme.typography.bodyMedium,
                                            color = MaterialTheme.colorScheme.onSurface
                                        )
                                        Text(
                        ...
                        Row() {
                            ...
                            Column(modifier = Modifier.weight(1f)) {
                                Box(
                                    ...
                                    Text(
                                        text = stringResource(R.string.setup_fcm_sender_step_e_title),
                                        style = MaterialTheme.typography.bodyLarge,
                                        color = MaterialTheme.colorScheme.onSurface
                                    )
                                }
                                ...
                                AnimatedVisibility(visible = currentStep == 4) {
                                    Column(
                                        ...
                                        Text(
                                            modifier = Modifier.padding(vertical = 8.dp),
                                            text = stringResource(R.string.setup_fcm_sender_step_e_text_a),
                                            style = MaterialTheme.typography.bodyMedium,
                                            color = MaterialTheme.colorScheme.onSurface
                                        )
                                        HyperlinkText(
                                            fullText = stringResource(R.string.setup_fcm_sender_step_e_text_b),
                                            hyperLinks = mapOf(stringResource(R.string.documentation) to "https://docs.parabox.ojhdt.dev/"),
