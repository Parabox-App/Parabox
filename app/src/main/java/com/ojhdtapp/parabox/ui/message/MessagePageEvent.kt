...
sealed interface MessagePageEvent : UiEvent {
    ...
    data class UpdateImagePreviewerSnapshotList(val list: List<MessagePageState.ImagePreviewerState.ImagePreviewerItem>, val targetElementIndex: Int) : MessagePageEvent
